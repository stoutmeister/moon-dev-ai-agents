...
from src.agents.short_agent import ShortAgent
...
ACTIVE_AGENTS = {
    ...
    'short': False,     # Short Agent - hunts short setups on Hyperliquid (paper trades)
...
def run_agents():
    ...
    try:
        ...
        short_agent = ShortAgent() if ACTIVE_AGENTS.get('short') else None
